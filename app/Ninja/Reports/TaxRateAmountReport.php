                ...
                foreach ($taxes as $tax) {
					foreach ($invoice->payments as $payment) {
						$this->data[] = [
						   ...
						   //$tax['name'],
							$tax['rate'] . '%',
							$this->isExport ? $tax['amount'] : $account->formatMoney($tax['amount'], $client),
							$this->isExport ? $tax['paid'] : $account->formatMoney($tax['paid'], $client),
							$this->isExport ? $invoice->amount : $invoice->present()->amount,
							$this->isExport ? $invoice->amount - $invoice->balance : $invoice->present()->paid,
